...
preproc_dir="/Volumes/ExtremeSSDD/LIBR_tACS/Preprocessing"
...
for subj in ${group_b_subjects[@]}; do
    session_id="MCR2"
...
3dttest++ -prefix group_comparison_OvN_Post_group_b -setA $group_paths
